...
public class DatosCampeonatoFinPrematuro{
    ...
    private void initData()
    {
        ...
        Organizacion organizacion = Organizacion.getInstancia(Collections.reverseOrder(new CMPComplejidadCircuito()), 1, 3);
        ...
        Escuderia peugeot = new EscuderiaReal("PEUGEOT", new SortByTotalPuntos(), false, new SortByDeposito(), false);
        ...
        Escuderia seat = new EscuderiaReal("SEAT", new SortByTotalPuntos(), false, new SortByDeposito(), false);
