 ...
 * el campeonato termina antes por estar todos los pilotos descalificados
 * 
...
public class DatosCampeonatoPremioDesierto{
    ...
    private void initData()
    {
        ...
        Organizacion organizacion = Organizacion.getInstancia(Collections.reverseOrder(new CMPDistanciaCircuito()), 1, 3);
        ...
        Escuderia peugeot = new EscuderiaReal("PEUGEOT", new SortByTotalPuntos() , false, new SortByDeposito(), true);
        ...
        Escuderia citroen = new EscuderiaReal("CITROEN", new SortByTotalPuntos(), true, new SortByDeposito(), true);
        ...
        Escuderia seat = new EscuderiaReal("SEAT", new SortByTotalPuntos(), false, new SortByDeposito(), true);
