...
import java.util.*;
/**
 * Sirve para ordenar la lista de Coches por Velocidad
 * 
 * @author Javier Florido Cartolano, Eugenia Andújar Sánchez y Carmen Martín Granado
 * @version v1 (30/12/2020)
 */
public class SortByVelocidad implements CMPStrategyCoche
{
    /**
    ...
    public void ordenarCoches(List <Coche> coches, boolean ASC){
        if(ASC){
            Collections.sort(coches, new CMPVelocidad());
        }
        else{
            Collections.sort(coches, Collections.reverseOrder(new CMPVelocidad()));
        }
    }
}
